...
date: 2024-10-31
image: "/assets/images/posts/ces.webp"
categories:
  - International
...
{% include elements/notice.html alert="info" text="Pour les jeunes en situation vulnérable, la durée du projet peut être réduite à 2 semaines ou 2 mois" %}
...
{% include elements/notice.html alert="info" text="En raison de leurs type et/ou mode de financement certains projets peuvent se voir adjoindre des restrictions supplémentaires en termes d'âge, de résidence ou de nationalité." %}
