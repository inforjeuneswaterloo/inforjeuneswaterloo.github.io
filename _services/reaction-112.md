...
La formation est accessible **gratuitement** aux 14-21 ans domiciliés ou scolarisés en Brabant-wallon.

Au programme: 

- Comment avertir les secours
- Réanimation + utilisation du défibrillateur
- Manoeuvres de désobstruction
- Mettre une victime en PLS (Position Latérale de Sécurité)
