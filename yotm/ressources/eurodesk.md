...
permalink: /yotm/ressources/eurodesk/
buttons:
  - btn:
      enable: true
      text: Explorer les opportunités
      href: /yotm/ressources/eurodesk/opportunites/
      target: _blank
      icon: fa-solid fa-angle-right
      class: btn btn-dark text-white text-decoration-none
  - btn:
      enable: true
      text: Trouver un point Eurodesk
      href: /yotm/ressources/eurodesk/points-infos/
      target: _blank
      icon: fa-solid fa-angle-right
      class: btn btn-dark text-white text-decoration-none
